...
class DynamicRegionRecognizer:
    ...
    LlguidanceTokenRecognizer, so ASAP's oracle trie/reweighting stay intact -- the
    ...
    def _maybe_transition(self, toks) -> None:
        """At a segment boundary (active grammar accepting) advance head -> then -> else."""
