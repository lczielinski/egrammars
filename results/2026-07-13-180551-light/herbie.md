# Herbie comparison — 2026-07-13-180551-light
...
|---|--:|--:|--:|---|
| asymptote_c | 1.59 | - | 0.28 | - |
| beta_a | 2.83 | 2.83 | 2.19 | herbie |
| beta_b | 2.87 | 3.02 | 2.23 | herbie |
| cancel_sqrt_2var | 0.01 | 0.05 | 0.01 | tie |
| cancel_sqrt_shift3 | 2.95 | - | 0.02 | - |
| cancel_sqrt_sum | 0.01 | 0.02 | 0.01 | tie |
| complex_square_real | 1.11 | 0.24 | 0.25 | tie |
| conte_near_pole | 8.14 | - | 0.32 | - |
| conte_x_minus_sqrt | 59.09 | 0.02 | 0.24 | ours |
| delta4 | 1.04 | 1.93 | 0.34 | herbie |
...
| himmilbeau | 0.04 | 0.04 | 0.03 | tie |
| kahan_p9 | 0.02 | 0.03 | 0.02 | tie |
| kepler0 | 0.56 | 0.41 | 0.28 | herbie |
| kepler1 | 0.77 | 0.85 | 0.60 | herbie |
| kepler2 | 1.29 | - | 0.94 | - |
| martel_p6 | 3.65 | 3.65 | 0.02 | herbie |
| matrixdeterminant | 0.17 | 0.16 | 0.17 | tie |
| matrixdeterminant2 | 0.16 | - | 0.17 | - |
...
| beta_b | 2.5e-16 abs | 3.2e-16 abs | - | - |
| cancel_sqrt_2var | 180.0 ulp | 2.2 ulp | 180.0 ulp | ours |
| cancel_sqrt_shift3 | 311.9 ulp | - | - | - |
| cancel_sqrt_sum | 179.4 ulp | 1.8 ulp | 179.4 ulp | ours |
| complex_square_real | 6.7e-16 abs | 6.1e-16 abs | 7.2e-16 abs | ours |
| conte_near_pole | - | - | 125.4 ulp | - |
| conte_x_minus_sqrt | 1.4e-13 abs | 7.4e-17 abs | - | - |
| delta4 | 5.8e-14 abs | 1.4e-13 abs | - | - |
| excel_x0 | 4.0e-16 abs | 116.1 ulp | 116.1 ulp | tie |
| expand_square | 1.1e-15 abs | 4.4e-16 abs | 4.4e-16 abs | tie |
| fastmath_dist4 | 6.5e-12 abs | 4.7e-12 abs | 4.7e-12 abs | tie |
| floudas1 | 2.9e-13 abs | 2.0e-13 abs | 2.4e-13 abs | ours |
| floudas3 | 1.2e-14 abs | 8.9e-15 abs | 1.2e-14 abs | ours |
| himmilbeau | 5.9e-13 abs | 5.9e-13 abs | 4.9e-13 abs | herbie |
| kahan_p9 | 4.0e-12 abs | 2.0e-12 abs | 4.0e-12 abs | ours |
| kepler0 | 5.4 ulp | 2.5 ulp | 2.2 ulp | herbie |
| kepler1 | 17.2 ulp | 14.0 ulp | - | - |
| kepler2 | - | - | 46.7 ulp | - |
| martel_p6 | 5.8e-15 abs | 5.8e-15 abs | 1.3e-15 abs | herbie |
| matrixdeterminant | 1.6e-12 abs | 1.5e-12 abs | - | - |
| matrixdeterminant2 | - | - | - | - |
| nmse_example_3_1 | 193.8 ulp | 1.6 ulp | 5.1 ulp | ours |
| nmse_example_3_6 | 8.4e-14 abs | 126.1 ulp | - | - |
| nmse_p42_negative | 2.3e-14 abs | - | 3.4e-14 abs | - |
| nmse_p42_positive | 2.3e-14 abs | 2.0 ulp | 3.4e-14 abs | ours |
...
| nmse_problem_3_3_1 | 1.9e-15 abs | 119306.5 ulp | 83474.9 ulp | herbie |
| nmse_problem_3_3_3 | 4.1e-16 abs | - | - | - |
| nonlin2 | 29958.8 ulp | 1.3 ulp | 1.4 ulp | ours |
| pbrt_cone_z | 2.2e-16 abs | 2.8e-16 abs | 1.7e-16 abs | herbie |
| rigidbody1 | 2.1e-13 abs | 1.4e-13 abs | 2.5e-13 abs | ours |
| rigidbody2 | 2.3e-11 abs | 2.4e-11 abs | - | - |
| sine | 4.4e-16 abs | 4.1e-16 abs | 4.2e-16 abs | ours |
| som_setup_w | 6.0e-16 abs | 5.0e-16 abs | - | - |
| sum | 2.3 ulp | 0.8 ulp | - | - |
| test03_nonlin2 | - | - | - | - |
| test04_dqmom9 | - | - | - | - |
| test05_nonlin1_r4 | 15597717409.8 ulp | 0.8 ulp | 601032842.2 ulp | ours |
| triangle | 17.6 ulp | 17.6 ulp | - | - |
| triangle1 | - | - | - | - |
