...
- valid (proven equivalent): **195 (22.7%)**
- invalid — missing e-graph rule (numerically equal, unproven): 56 (6.5%)
- invalid — non-equivalent (model error): 582 (67.7%)
- indeterminate (no finite sample point): 27 (3.1%)

## Benchmarks
- produced >=1 valid rewrite: **34/43 (79.1%)**
- accuracy improved over reference: **21/43 (48.8%)**
- valid rewrite but no accuracy gain: 6/43
- best valid rewrite was worse than reference: 6/43
- unmeasurable (box straddles zero / singularity): 1/43
- no valid rewrite found: 9/43
- had a missing-rule candidate: 19/43 (44.2%)
...
| nmse_example_3_6 | 20 | 6 | 126.1 | worse (abs) |
| nmse_p42_negative | 20 | 2 | - | unmeasurable |
| nmse_problem_3_2_1_negative | 20 | 8 | 2.0 | no-change (abs) |
